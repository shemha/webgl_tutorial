...
function main() {
  ...
  var y1 =
    y + ((Math.sin(((angle + 270) * Math.PI) / 180) * lineWidth) / 2) * -1;

  var x2 = dx + (Math.cos(((angle + 270) * Math.PI) / 180) * lineWidth) / 2;
  var y2 =
    dy + ((Math.sin(((angle + 270) * Math.PI) / 180) * lineWidth) / 2) * -1;

  var x3 = x + (Math.cos(((angle + 90) * Math.PI) / 180) * lineWidth) / 2;
  var y3 =
    y + ((Math.sin(((angle + 90) * Math.PI) / 180) * lineWidth) / 2) * -1;

  var x4 = dx + (Math.cos(((angle + 90) * Math.PI) / 180) * lineWidth) / 2;
  var y4 =
    dy + ((Math.sin(((angle + 90) * Math.PI) / 180) * lineWidth) / 2) * -1;
