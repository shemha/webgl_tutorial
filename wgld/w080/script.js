...
function render() {
  ...
  // 正射影用シェーダ
  v_shader = create_shader("videoVS");
  f_shader = create_shader("videoFS");
  ...
  oUniLocation[2] = gl.getUniformLocation(oPrg, "difference");
  ...
  (function () {
    ...
    gl.uniform1f(oUniLocation[2], dRange.value / 100);
