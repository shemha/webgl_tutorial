(function () {
  ...
  window.addEventListener(
    ...
    function () {
      ...
      // texture setting
      (function () {
        create_texture("lenna.jpg", function (texture) {
          init(texture);
        });
      })();
      ...
      function init(texture) {
        ...
        var sphereVAO = create_vao(
          [sphereData.p, sphereData.n, sphereData.t],
          attLocation,
          attStride,
          sphereData.i
        );
        ...
        gl.bindSampler(1, samplerNearest);
        gl.activeTexture(gl.TEXTURE2);
        gl.bindTexture(gl.TEXTURE_2D, texture);
        gl.bindSampler(2, samplerLinear);

        // setting
        var lightPosition = [5.0, 5.0, 2.0];
        ...
        function render() {
          ...
          mat.translate(mMatrix, [1.0, 0.0, 0.0], mMatrix);
          mat.rotate(mMatrix, Math.PI / 2.0, [0.0, 1.0, 0.0], mMatrix);
          mat.multiply(vpMatrix, mMatrix, mvpMatrix);
          mat.inverse(mMatrix, invMatrix);
          mat.transpose(invMatrix, normalMatrix);

          // first sphere (nearest)
