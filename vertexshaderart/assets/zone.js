        ...
        (function (global) {
          ...
          global.Zone._apply = function apply(f, c, a) {
            ...
            switch (a.length) {
              ...
              case 4:
                return f.call(c, a[0], a[1], a[2], a[3]);
              case 5:
                return f.call(c, a[0], a[1], a[2], a[3], a[4]);
              case 6:
                return f.call(c, a[0], a[1], a[2], a[3], a[4], a[5]);
              case 7:
                return f.call(c, a[0], a[1], a[2], a[3], a[4], a[5], a[6]);
              default:
                return f.apply(c, a);
            }
          };
          ...
          function apply() {
            ...
            if (global.EventTarget) {
              ...
              apis.forEach(function (thing) {
                global[thing] &&
                  utils.patchEventTargetMethods(global[thing].prototype, thing);
              });
            }
          }
    ...
    11: [
      function (require, module, exports) {
        (function (global) {
          ...
          var _redefineProperty =
            require("./define-property")._redefineProperty;
              ...
              if (delegate) {
                obj[name] = function () {
                  ...
                  return delegate.apply(
                    this,
                    bindArguments(arguments, ownerInfo)
                  );
                };
              }
            });
          ...
          function patchEventTargetMethods(obj, thing) {
            ...
            obj.addEventListener = function (eventName, fn) {
              ...
              if (this && this.attributes) {
                ...
                var attributesArray = Array.prototype.slice.call(
                  this.attributes
                );
              ...
              fn._bound = fn._bound || {};
              arguments[1] = fn._bound[eventName] = zone.bind(
                fn,
                false,
                ownerInfo
              );
