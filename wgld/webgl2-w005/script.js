  ...
  window.addEventListener(
    ...
    function () {
      ...
      function init(texture) {
        ...
        var planeVBO = [create_vbo(planePosition)];
        var planeIBO = create_ibo(planeIndex);

        // sphere and torus
        var sphereData = sphere(16, 16, 0.75);
        var spherePosition = sphereData.p;
        var sphereNormal = sphereData.n;
        var sphereTexCoord = sphereData.t;
        var sphereVBO = [
          create_vbo(spherePosition),
          create_vbo(sphereNormal),
          create_vbo(sphereTexCoord),
        ];
        var sphereIBO = create_ibo(sphereData.i);
        var torusData = torus(32, 32, 0.25, 1.25);
        var torusPosition = torusData.p;
        var torusNormal = torusData.n;
        var torusTexCoord = torusData.t;
        var torusVBO = [
          create_vbo(torusPosition),
          create_vbo(torusNormal),
          create_vbo(torusTexCoord),
        ];
        var torusIBO = create_ibo(torusData.i);
        ...
        function render() {
          ...
          // attribute
          set_attribute(sphereVBO, attLocation, attStride);
          ...
          // attribute
          set_attribute(torusVBO, attLocation, attStride);
          ...
          // attribute
          set_attribute(planeVBO, pAttLocation, pAttStride);
