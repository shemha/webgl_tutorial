onload = function () {
  ...
  (function () {
    ...
    // 単位行列に変更
    m.identity(mMatrix);
    // 参照する行列・原点からの移動距離・回転軸・演算結果を指定して行列を並進変換する
    ...
    // lightDirectionは3つの成分を持つベクトルなのでuniform3fvメソッドを使用して登録
    gl.uniform3fv(uniLocation[3], lightPosition);
    gl.uniform3fv(uniLocation[4], eyeDirection);
    // ambientColorは4つの成分を持つベクトルなのでuniform4fvメソッドを使用して登録
