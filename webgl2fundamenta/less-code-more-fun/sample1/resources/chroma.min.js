!function () {
    ...
    Color.prototype.css = function (mode) {
      ...
      if (mode === "rgb") {
        ...
        return (
          mode +
          "(" +
          rgb.slice(0, 3).map(Math.round).join(",") +
          "," +
          rgb[3] +
          ")"
        );
  ...
  chroma.scale = function (colors, positions) {
    ...
    setColors = function (colors, positions) {
      ...
      if (
        colors != null &&
        type(colors) === "string" &&
        ((_ref = chroma.brewer) != null ? _ref[colors] : void 0) != null
      ) {
  ...
  chroma.limits = function (data, mode, num) {
    ...
    if (mode.substr(0, 1) === "e") {
      ...
      for (
        i = _w = 1, _ref15 = tmpKMeansBreaks.length - 1;
        _w <= _ref15;
        i = _w += 2
      ) {
