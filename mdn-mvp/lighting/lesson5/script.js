...
BunnyDemo.prototype.createLocations = function () {
  ...
  var locations = {
    ...
    specularShininess: gl.getUniformLocation(
      this.webglProgram,
      "specularShininess"
    ),
...
BunnyDemo.prototype.addDatGui = function () {
  ...
  var syncWithUniforms = function () {
    if (
      light.lightDirectionX === 0 &&
      light.lightDirectionY === 0 &&
      light.lightDirectionZ === 0
    ) {
  ...
  gui.addColor(colors, "diffuseColor").onChange(
    function () {
      this.color = from255(colors.diffuseColor);
    }.bind(this)
  );

  gui.addColor(colors, "specularColor").onChange(
    function () {
