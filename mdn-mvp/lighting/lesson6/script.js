...
BunnyDemo.prototype.setupProgram = function () {
  ...
  var webglProgram = MDN.createWebGLProgramFromIds(
    gl,
    "vertex-shader",
    "fragment-shader"
  );
...
BunnyDemo.prototype.computeViewMatrix = function () {
  ...
  var view = MDN.invertMatrix(MDN.translateMatrix(0, 5, 10));
...
BunnyDemo.prototype.createLights = function () {
  ...
  this.locations.lights = {
    ...
    linearAttenuation: this.gl.getUniformLocation(
      this.webglProgram,
      "lightLinearAttenuation"
    ),
    quadraticAttenuation: this.gl.getUniformLocation(
      this.webglProgram,
...
BunnyDemo.prototype.updateAttributesAndUniforms = function () {
  ...
  gl.uniform1fv(
    this.locations.lights.linearAttenuation,
    this.buffers.lights.linearAttenuation
  );
  gl.uniform1fv(
    this.locations.lights.quadraticAttenuation,
    this.buffers.lights.quadraticAttenuation
  );
